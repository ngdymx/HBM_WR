...
void write2HBM(hls::burst_maxi<fdtd_cell_pack> mem, hls::stream<fdtd_cell_pack>& stream_in, hls::stream<ap_uint<1>>& flag_stream_out){
#pragma HLS INTERFACE ap_ctrl_none port = return
...
void readfromHBM(hls::burst_maxi<fdtd_cell_pack> mem, hls::stream<ap_uint<1>>& flag_stream_in, hls::stream<fdtd_cell_pack>& stream_out){
#pragma HLS INTERFACE ap_ctrl_none port = return
    for(int count = 0; count < (HBM_SIZE >> 12); count++){
#pragma HLS PIPELINE off
        ap_uint<1> temp;
...
void layer_buffer_hbm00(hls::burst_maxi<fdtd_cell_pack> mem1, hls::burst_maxi<fdtd_cell_pack> mem2, hls::stream<fdtd_cell>& stream_in, hls::stream<fdtd_cell>& stream_out){
#pragma HLS INTERFACE ap_ctrl_none port = return
...
#pragma HLS INTERFACE m_axi port=mem2 bundle=gmem2 num_read_outstanding=4 num_write_outstanding=1 latency=4 offset=slave
    ...
    hls_thread_local hls::stream<fdtd_cell_pack> pack_stream_out;
    hls_thread_local hls::stream<fdtd_cell_pack> pack_stream_in;
